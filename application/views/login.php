                ...
                <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                    <form action="<?php echo base_url("login/login_proses");?>" method="post">
                        <div class="d-flex flex-row align-items-center justify-content-center justify-content-lg-start">
                            <p class="lead fw-normal mb-0 me-3">Login Form</p>
                        ...
                        <button class="btn btn-block btn-primary" type="submit"><i class="si si-login pull-right" style="color:white"></i> Log in</button>
